# Managing Credit Cards - Within the Budget
...
If you are unable to budget for and pay your credit card outstanding balance then we also have you covered, see the [Carrying Debt](./carrying-debt.md) page for a step-by-step guide on how to set up Actual and track this debt in a safe and sustainable manner. Follow what we describe down below for any new credit card purchases.

We highly recommend you follow this _Within the Budget_ strategy. _Every_ time you make a credit card purchase, enter the transaction and select a category with money set aside in the Budgeted column and a positive Budget Balance. As long as you do not overspend in any category you will not incur any new debt and can pay the credit card bill in full whenever it arrives. 
...
If you have recently moved to Actual from nYNAB, you will notice that Actual doesn't use specific "credit card" accounts, nor does it have a specific Credit Card Group in the Budget. Actual shows credit card account balances as a negative value and subtracts them directly from your Available Funds. If you don't budget funds you don't have and don't spend money that is not covered in your budget, you will always have enough funds to pay your credit card New Purchases every month!
...
Every time we use the card, we choose a category with a positive Budget Balance. Our account closes on the 7th of every month and our statement arrives s few days later. When the July statement arrives, our Chase account looks like this:
...
Our July statement looks something like this:

**Chase Account Summary - July 2025**
- Statement Period: June 7, 2025 – July 7, 2025
- Account Number: 4424 9012 5678 1234
...
When we reconcile our account for this first month, we clear all of the June purchases (which should be part of the "Starting Balance") in one lump. In our case they add up to $35.00.
...
- Statement Period: July 7, 2025 – August 7, 2025
- Account Number: 4424 9012 5678 1234
- Credit Limit: $5,000.00
- Available Credit: $
...
- Interest Charged: $0.00
- New Balance: $213.15
- Payment Due Date: August 16, 2025
- Minimum Payment Due: $25.00
...
Hopefully after looking through this example you've seen that managing credit card spending safely can be pretty easy with a little bit of planning.
