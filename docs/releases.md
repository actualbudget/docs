...
- [#4825](https://github.com/actualbudget/actual/pull/4825) Fix CLI issue where `ACTAUL_DATA_DIR` env variable was not being respected when no config is present — thanks @MikesGlitch
