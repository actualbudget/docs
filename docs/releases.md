...
- [#2466](https://github.com/actualbudget/actual/pull/2466) Enable "yearly" interval to custom reports. Also sets-up groudwork for adding weekly/daily in the near future — thanks @carkom
...
- [#2651](https://github.com/actualbudget/actual/pull/2651) Make the 'Apply to all' section (fka 'Before split') of rule splits more intuitive — thanks @jfdoming
...
- [#2688](https://github.com/actualbudget/actual/pull/2688) Goals: Add template to budget X months average spending. Matches the funcion of the existing budget page button. — thanks @youngcw
