...
The server provides a web based version of Actual.  This web app can be used in a browser as a standard web page to use view and edit your budget.  The web page can also be installed to your device.  For mobile devices an installed web page will work offline.
