...
3. Run `yarn workspaces focus actual-sync --production` from that directory. This will download the latest web client code, along with any updated dependencies for the server.
