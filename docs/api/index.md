...
Many people mistake the term "API" for a HTTP and/or RESTful API. Actual **does not** expose HTTP endpoints that can be called. We do, however, offer a NPM package - API - that allows interacting with the product programmatically.
